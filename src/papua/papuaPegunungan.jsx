...
function PapuaPegunungan() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://id.wikipedia.org/api/rest_v1/page/summary/Papua_Pegunungan');
    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow p-4">
        <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-lg">
          ...
          {image && <img src={image} alt="Papua Pegunungan" className="w-full h-auto mb-4 rounded-lg" />}
